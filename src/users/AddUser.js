...
import { Link, useNavigate } from 'react-router-dom';//npm i react-router-dom
...
export default function AddUser() {
    ...
    const onSubmit=async(e)=>{
        ...
        //HTTP POST REQUEST WITH JS OBJECT
        await axios.post("http://localhost:8080/userManagement/postUser",user)
